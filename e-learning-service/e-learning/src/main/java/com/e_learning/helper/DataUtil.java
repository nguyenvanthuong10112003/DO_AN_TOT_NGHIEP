...
public final class DataUtil {
    ...
    public static <T, X> void pushIfNotContain(Map<T, X> map, T key, X value) {
        if (map == null) return;
    ...
    public static <T> boolean hasDuplicate(List<T> objectList) {
        if (DataUtil.isNullOrEmpty(objectList)) return true;
        Set<Object> set = new HashSet<>(objectList);
        return set.size() == objectList.size();
    }
}
