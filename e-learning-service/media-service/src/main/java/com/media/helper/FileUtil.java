...
public class FileUtil {
    ...
    private static Integer getQuality(Integer height) {
        if (height >= Const.Quality._1080p.getHeight()) {
            return Const.Quality._1080p.getHeight();
        }

        if (height >= Const.Quality._720p.getHeight()) {
            return Const.Quality._720p.getHeight();
        }

        return Const.Quality._480p.getHeight();
    }
}
